...
Again, still using set.seed(123), when we reversed and complemented the sequences, we observed **897 stop codons** for the original sequence, **1107 stop codons** for the first simulated sequence and **527 stop codons** for the second simulated sequence.
