...
model3=c("both traits asindependent Ornstein Uhlenbeck processes", 654.5278, 654.8914)
...
```
**From the above comparison matrix of Akaike information criterion values only, we can see that the model were the traits are independent Ornstein Uhlenbeck processes has the lowest values of 654.5278 for AIC. AIC values are used to compare different models.** 
...
**This means that among the above five models, the independent Ornstein Uhlenbeck process loses the least information about the traits.**
