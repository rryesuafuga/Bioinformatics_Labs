...
**The model has AIC of 1295.603 and AIC.c of 1296.235**
...
model2=c("The traits evolve as a correlated Brownian motion", 1323.473, 1323.921)

model3=c("independent Ornstein Uhlenbeck processes", 654.5278, 654.8914)

model4=c("traits evolve as a bivariate Ornstein-Uhlenbeck process", 
         1161.213, 1162.312)

model5=c("size evolves as a Brownian motion and range as an Ornstein Uhlenbeck", 
         1295.603, 1296.235)
...
names(comparison_matrix) <- c("model", "AIC", "AIC.c")
...
```
**From the above comparison matrix of AIC and AICs, we can see that the model were the traits are modeled as independent Ornstein Uhlenbeck processes has the lowest values of 654.5278 for AIC and 654.8914 for AICc. The lowest AIC and AICc values are the most desirable.** 
...
**Therefore, this is the best model among the five.**
